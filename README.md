...
Start with **Project 01** (RAG) to understand the basics of embeddings and document retrieval.  
Then try **Project 02** (Validator) to learn about structured outputs.  
Work through them in order — each one builds on concepts from the previous.
...
- Uses `gpt-3.5-turbo` (cheap and fast — great for learning)
